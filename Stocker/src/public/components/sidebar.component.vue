...
export default {
  ...
  mounted() {
    ...
    const stocker = document.getElementById("stocker");
    ...
    cloud.addEventListener("click",()=>{
      stocker.classList.toggle("oculto");
   ...
   <div class="barra-lateral">
     <div>
       <div class="nombre-pagina">
         <img id="cloud" src="../../assets/images/logo_white.webp">
       ...
       <div class="usuario">
         <div class="info-usuario">
           <div class="nombre-email">
             <span class="nombre">Pichulin</span>
             <span class="email">pichulin@gmail.com</span>
           </div>
